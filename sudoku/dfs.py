...
class Sudoku:
    ...
    def dfs_solve(self):
        '''
        Solves the game from its current state with a DFS algorithm.
        ...
        # Get possible moves for the current cell
        possible_moves = self.get_possible_moves(empty_cell)

        # Try each possible move recursively
        for move in possible_moves:
            empty_cell.value = move
